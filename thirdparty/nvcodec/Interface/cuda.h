...
#define cuStreamUpdateCaptureDependencies \
  __CUDA_API_PTSZ(cuStreamUpdateCaptureDependencies)
...
typedef unsigned long long CUtexObject_v1; /**< An opaque value that represents
                                              a CUDA texture object */
typedef CUtexObject_v1
    CUtexObject; /**< An opaque value that represents a CUDA texture object */
typedef unsigned long long CUsurfObject_v1; /**< An opaque value that represents
                                               a CUDA surface object */
typedef CUsurfObject_v1
...
typedef enum CUevent_record_flags_enum {
  ...
  CU_EVENT_RECORD_EXTERNAL =
      0x1 /**< When using stream capture, create an event record node
...
typedef enum CUevent_wait_flags_enum {
  ...
  CU_EVENT_WAIT_EXTERNAL =
      0x1 /**< When using stream capture, create an event wait node
           *  instead of the default behavior.  This flag is invalid
           *  when used outside of capture.*/
} CUevent_wait_flags;
...
typedef enum CUstreamUpdateCaptureDependencies_flags_enum {
  CU_STREAM_ADD_CAPTURE_DEPENDENCIES =
      0x0, /**< Add new nodes to the dependency set */
  CU_STREAM_SET_CAPTURE_DEPENDENCIES =
      0x1 /**< Replace the dependency set with the new nodes */
...
typedef enum CUdevice_attribute_enum {
  ...
  CU_DEVICE_ATTRIBUTE_COOPERATIVE_MULTI_DEVICE_LAUNCH =
      96, /**< Deprecated, ::cuLaunchCooperativeKernelMultiDevice is deprecated.
           */
  CU_DEVICE_ATTRIBUTE_MAX_SHARED_MEMORY_PER_BLOCK_OPTIN =
      97, /**< Maximum optin shared memory per block */
  CU_DEVICE_ATTRIBUTE_CAN_FLUSH_REMOTE_WRITES =
      98, /**< The ::CU_STREAM_WAIT_VALUE_FLUSH flag and the
  ...
  CU_DEVICE_ATTRIBUTE_VIRTUAL_MEMORY_MANAGEMENT_SUPPORTED =
      102, /**< Device supports virtual memory management APIs like
              ::cuMemAddressReserve, ::cuMemCreate, ::cuMemMap and related APIs
            */
  CU_DEVICE_ATTRIBUTE_HANDLE_TYPE_POSIX_FILE_DESCRIPTOR_SUPPORTED =
      103, /**< Device supports exporting memory to a posix file descriptor with
              ::cuMemExportToShareableHandle, if requested via ::cuMemCreate */
  CU_DEVICE_ATTRIBUTE_HANDLE_TYPE_WIN32_HANDLE_SUPPORTED =
      104, /**< Device supports exporting memory to a Win32 NT handle with
              ::cuMemExportToShareableHandle, if requested via ::cuMemCreate */
  ...
  CU_DEVICE_ATTRIBUTE_GENERIC_COMPRESSION_SUPPORTED =
      107, /**< Device supports compression of memory */
  CU_DEVICE_ATTRIBUTE_MAX_PERSISTING_L2_CACHE_SIZE =
      108, /**< Maximum L2 persisting lines capacity setting in bytes. */
  CU_DEVICE_ATTRIBUTE_MAX_ACCESS_POLICY_WINDOW_SIZE =
      109, /**< Maximum value of CUaccessPolicyWindow::num_bytes. */
  CU_DEVICE_ATTRIBUTE_GPU_DIRECT_RDMA_WITH_CUDA_VMM_SUPPORTED =
      110, /**< Device supports specifying the GPUDirect RDMA flag with
              ::cuMemCreate */
  CU_DEVICE_ATTRIBUTE_RESERVED_SHARED_MEMORY_PER_BLOCK =
      111, /**< Shared memory reserved by CUDA driver per block in bytes */
  CU_DEVICE_ATTRIBUTE_SPARSE_CUDA_ARRAY_SUPPORTED =
      112, /**< Device supports sparse CUDA arrays and sparse CUDA mipmapped
              arrays */
  ...
  CU_DEVICE_ATTRIBUTE_MEMORY_POOLS_SUPPORTED =
      115, /**< Device supports using the ::cuMemAllocAsync and ::cuMemPool
              family of APIs */
  CU_DEVICE_ATTRIBUTE_GPU_DIRECT_RDMA_SUPPORTED =
      116, /**< Device supports GPUDirect RDMA APIs, like nvidia_p2p_get_pages
              (see https://docs.nvidia.com/cuda/gpudirect-rdma for more
              information) */
  CU_DEVICE_ATTRIBUTE_GPU_DIRECT_RDMA_FLUSH_WRITES_OPTIONS =
      117, /**< The returned attribute shall be interpreted as a bitmask, where
              the individual bits are described by the
              ::CUflushGPUDirectRDMAWritesOptions enum */
  CU_DEVICE_ATTRIBUTE_GPU_DIRECT_RDMA_WRITES_ORDERING =
      118, /**< GPUDirect RDMA writes to the device do not need to be flushed
              for consumers within the scope indicated by the returned
              attribute. See ::CUGPUDirectRDMAWritesOrdering for the numerical
...
typedef enum CUpointer_attribute_enum {
  ...
  CU_POINTER_ATTRIBUTE_IS_LEGACY_CUDA_IPC_CAPABLE =
      10, /**< 1 if this pointer maps to an allocation that is suitable for
             ::cudaIpcGetMemHandle, 0 otherwise **/
  CU_POINTER_ATTRIBUTE_RANGE_START_ADDR =
      11, /**< Starting address for this requested pointer */
  CU_POINTER_ATTRIBUTE_RANGE_SIZE =
      12, /**< Size of the address range for this requested pointer */
  CU_POINTER_ATTRIBUTE_MAPPED =
      13, /**< 1 if this pointer is in a valid address range that is mapped to a
             backing allocation, 0 otherwise **/
  CU_POINTER_ATTRIBUTE_ALLOWED_HANDLE_TYPES =
      14, /**< Bitmask of allowed ::CUmemAllocationHandleType for this
             allocation **/
  CU_POINTER_ATTRIBUTE_IS_GPU_DIRECT_RDMA_CAPABLE =
      15, /**< 1 if the memory this pointer is referencing can be used with the
             GPUDirect RDMA API **/
  CU_POINTER_ATTRIBUTE_ACCESS_FLAGS =
      16, /**< Returns the access flags the device associated with the current
...
typedef enum CUlimit_enum {
  ...
  CU_LIMIT_PERSISTING_L2_CACHE_SIZE =
      0x06, /**< A size in bytes for L2 persisting lines cache size */
  CU_LIMIT_MAX
} CUlimit;
...
typedef enum CUgraphNodeType_enum {
  ...
  CU_GRAPH_NODE_TYPE_EXT_SEMAS_SIGNAL =
      8,                                 /**< External semaphore signal node */
...
typedef enum cudaError_enum {
  ...
  /**
   * This error indicates the the hardware resources required to support device
...
/**
 * Indicates that the layered sparse CUDA array or CUDA mipmapped array has a
 * single mip tail region for all layers
 */
 ...
 * default to ensure data coherency with other importers of the same NvSciBuf
 * memory objects.
 */
...
typedef CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC_v1
...
typedef CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS_v1
...
typedef CUDA_EXTERNAL_SEMAPHORE_WAIT_PARAMS_v1
...
typedef struct CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_st {
  ...
  unsigned int numExtSems; /**< Number of handles and parameters supplied in
                              extSemArray and paramsArray. */
...
typedef struct CUDA_EXT_SEM_WAIT_NODE_PARAMS_st {
  ...
  const CUDA_EXTERNAL_SEMAPHORE_WAIT_PARAMS
      *paramsArray;        /**< Array of external semaphore wait parameters. */
  unsigned int numExtSems; /**< Number of handles and parameters supplied in
                              extSemArray and paramsArray. */
...
typedef struct CUmemPoolProps_st {
  CUmemAllocationType
      allocType; /**< Allocation type. Currently must be specified as
...
typedef enum CUGPUDirectRDMAWritesOrdering_enum {
  CU_GPU_DIRECT_RDMA_WRITES_ORDERING_NONE =
      0, /**< The device does not natively support ordering of remote writes.
            ::cuFlushGPUDirectRDMAWrites() can be leveraged if supported. */
  CU_GPU_DIRECT_RDMA_WRITES_ORDERING_OWNER =
      100, /**< Natively, the device can consistently consume remote writes,
              although other CUDA devices may not. */
  CU_GPU_DIRECT_RDMA_WRITES_ORDERING_ALL_DEVICES =
      200 /**< Any CUDA device in the system can consistently consume remote
...
typedef enum CUuserObject_flags_enum {
  CU_USER_OBJECT_NO_DESTRUCTOR_SYNC =
      1 /**< Indicates the destructor execution is not synchronized by any CUDA
           handle. */
} CUuserObject_flags;
...
typedef enum CUuserObjectRetain_flags_enum {
  CU_GRAPH_USER_OBJECT_MOVE = 1 /**< Transfer references from the caller rather
                                   than creating new references. */
...
/**
 * \brief Returns the maximum number of elements allocatable in a 1D linear
 ...
 *
 * \param maxWidthInElements    - Returned maximum number of texture elements
 * allocatable for given \p format and \p numChannels. \param format - Texture
 * format. \param numChannels           - Number of channels per texture
 * element. \param dev                   - Device handle.
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_DEINITIALIZED,
 ...
 * set both wait and signal specific attributes in the same \p
 * nvSciSyncAttrList.
 *
 * \param nvSciSyncAttrList     - Return NvSciSync attributes supported.
 * \param dev                   - Valid Cuda Device to get NvSciSync attributes
 * for. \param flags                 - flags describing NvSciSync usage.
 *
 * \return
 *
 * ::CUDA_SUCCESS,
 ...
 * ::cuMemAllocAsync allocates from the current mempool of the provided stream's
 * device. By default, a device's current memory pool is its default memory
 * pool.
 *
 * \note Use ::cuMemAllocFromPoolAsync to specify asynchronous allocations from
 ...
 * ::CUDA_ERROR_INVALID_VALUE
 *
 * \sa ::cuDeviceGetDefaultMemPool, ::cuDeviceGetMemPool, ::cuMemPoolCreate,
 ...
 * or the device's default memory pool if ::cuDeviceSetMemPool has never been
 ...
 * \notefnerr
 *
 * \sa ::cuMemAllocAsync, ::cuMemPoolTrimTo, ::cuMemPoolGetAttribute,
 * ::cuMemPoolSetAttribute, cuMemPoolSetAccess, ::cuDeviceGetMemPool,
 * ::cuMemPoolCreate
 */
 ...
 *
 * \param target - The target of the operation, see
 * ::CUflushGPUDirectRDMAWritesTarget \param scope  - The scope of the
 ...
 * with ::cuDevicePrimaryCtxRelease() or resets it with
...
/**
 * \brief Returns information about the execution affinity support of the
 * device.
 *
 * Returns in \p *pi whether execution affinity type \p type is supported by
 * device \p dev. The supported types are:
 * - ::CU_EXEC_AFFINITY_TYPE_SM_COUNT: 1 if context with limited SMs is
 * supported by the device, or 0 if not;
 *
 * \param pi   - 1 if the execution affinity type \p type is supported by the
 * device, or 0 if not \param type - Execution affinity type to query \param dev
 * - Device handle
 *
 * \return
 * ::CUDA_SUCCESS,
 ...
 * the calling thread. The \p paramsArray and \p flags parameter are described
 * below. The context is created with a usage count of 1 and the caller of
 * ::cuCtxCreate() must call ::cuCtxDestroy() or when done using the context. If
 * a context is already current to the thread, it is supplanted by the newly
 * created context and may be restored by a subsequent call to
 * ::cuCtxPopCurrent().
 *
 * The type and the amount of execution resource the context can use is limited
 * by \p paramsArray and \p numParams. The \p paramsArray is an array of \p
 * CUexecAffinityParam and the \p numParams describes the size of the array. If
 * two \p CUexecAffinityParam in the array have the same type, the latter
 * execution affinity parameter overrides the former execution affinity
 * parameter. The supported execution affinity types are:
 * - ::CU_EXEC_AFFINITY_TYPE_SM_COUNT limits the portion of SMs that the context
 * can use. The portion of SMs is specified as the number of SMs via \p
 * CUexecAffinitySmCount. This limit will be internally rounded up to the next
 * hardware-supported amount. Hence, it is imperative to query the actual
 * execution affinity of the context via \p cuCtxGetExecAffinity after context
 ...
 * granularity. Values can range from 0B to 128B. This is purely a performence
 ...
 * reference count on the handle is incremented by 1 and the existing device
 * pointer is returned.
 *
 ...
 *
 * Decrements the reference count of the memory returned by ::cuIpcOpenMemHandle
 * by 1. When the reference count reaches 0, this API unmaps the memory. The
 * original allocation in the exporting process as well as imported mappings in
 * other processes will be unaffected.
 *
 ...
 *
 * \param dstDevice - Destination device pointer
 * \param dstPitch  - Pitch of destination device pointer(Unused if \p Height is
 * 1) \param uc        - Value to set \param Width     - Width of row \param
 ...
 * \param dstDevice - Destination device pointer
 * \param dstPitch  - Pitch of destination device pointer(Unused if \p Height is
 * 1) \param us        - Value to set \param Width     - Width of row \param
 * Height    - Number of rows
 *
 * \return
 * ::CUDA_SUCCESS,
 ...
 * \param dstDevice - Destination device pointer
 * \param dstPitch  - Pitch of destination device pointer(Unused if \p Height is
 * 1) \param ui        - Value to set \param Width     - Width of row \param
 * Height    - Number of rows
 *
 * \return
 * ::CUDA_SUCCESS,
 ...
 * \param dstPitch  - Pitch of destination device pointer(Unused if \p Height is
 * 1) \param uc        - Value to set \param Width     - Width of row \param
 * Height    - Number of rows \param hStream   - Stream identifier
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_DEINITIALIZED,
 ...
 * ::CUDA_ARRAY_SPARSE_PROPERTIES::miptailSize represents the total size of the
 * array. Otherwise, it will be zero. Also, the returned value in
 * ::CUDA_ARRAY_SPARSE_PROPERTIES::miptailFirstLevel is always zero. Note that
 * the \p array must have been allocated using ::cuArrayCreate or
 * ::cuArray3DCreate. For CUDA arrays obtained using ::cuMipmappedArrayGetLevel,
 * ::CUDA_ERROR_INVALID_VALUE will be returned. Instead,
 * ::cuMipmappedArrayGetSparseProperties must be used to obtain the sparse
 * properties of the entire CUDA mipmapped array to which \p array belongs to.
 *
 * \return
 * ::CUDA_SUCCESS
 * ::CUDA_ERROR_INVALID_VALUE
 ...
 * ::CUDA_ARRAY_SPARSE_PROPERTIES::miptailSize returns the size of the mip tail
 * region. The mip tail region includes all mip levels whose width, height or
 * depth is less than that of the tile. For layered CUDA mipmapped arrays, if
 * ::CUDA_ARRAY_SPARSE_PROPERTIES::flags contains
 * ::CU_ARRAY_SPARSE_PROPERTIES_SINGLE_MIPTAIL, then
 ...
 *
 * If \p planeIdx is greater than the maximum number of planes in this array or
 * if the array does not have a multi-planar format e.g: ::CU_AD_FORMAT_NV12,
 * then ::CUDA_ERROR_INVALID_VALUE is returned.
 *
 * Note that if the \p hArray has format ::CU_AD_FORMAT_NV12, then passing in 0
 * for \p planeIdx returns a CUDA array of the same size as \p hArray but with
 * one channel and ::CU_AD_FORMAT_UNSIGNED_INT8 as its format. If 1 is passed
 * for \p planeIdx, then the returned CUDA array has half the height and width
 * of \p hArray with two channels and ::CU_AD_FORMAT_UNSIGNED_INT8 as its
 * format.
 *
 ...
 *
 * ___MANBRIEF___ virtual memory management functions of the low-level CUDA
 * driver API
 * (___CURRENT_FILE___) ___ENDMANBRIEF___
 *
 ...
 * alignment.
 *
 * \param[out] ptr       - Resulting pointer to start of virtual address range
 * allocated \param[in]  size      - Size of the reserved virtual address range
 * requested \param[in]  alignment - Alignment of the reserved virtual address
 * range requested \param[in]  addr      - Fixed starting address range
 * requested \param[in]  flags     - Currently unused, must be zero \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
 * ::CUDA_ERROR_OUT_OF_MEMORY,
 * ::CUDA_ERROR_NOT_INITIALIZED,
...
/**
 * \brief Create a CUDA memory handle representing a memory allocation of a
 ...
 * ::CU_MEM_CREATE_USAGE_TILE_POOL flag then the memory allocation is intended
 * only to be used as backing tile pool for sparse CUDA arrays and sparse CUDA
 * mipmapped arrays. (see ::cuMemMapArrayAsync).
 *
 * \param[out] handle - Value of handle returned. All operations on this
 * allocation are to be performed using this handle. \param[in]  size   - Size
 * of the allocation requested \param[in]  prop   - Properties of the allocation
 * to create. \param[in]  flags  - flags for future use, must be zero now.
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
 * ::CUDA_ERROR_OUT_OF_MEMORY,
 ...
 * \notefnerr
 *
 * \sa ::cuMemRelease, ::cuMemExportToShareableHandle,
 ...
 * (including it's shareable counterparts) are also released. The generic memory
 * handle can be freed when there are still outstanding mappings made with this
 * handle. Each time a recepient process imports a shareable handle, it needs to
 * pair it with
 * ::cuMemRelease for the handle to be freed.  If \p handle is not a valid
 * handle the behavior is undefined.
 *
 * \param[in] handle Value of handle which was returned previously by
 * cuMemCreate. \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
 * ::CUDA_ERROR_NOT_INITIALIZED,
 ...
 * \notefnerr
 *
 * \sa ::cuMemUnmap, ::cuMemSetAccess, ::cuMemCreate, ::cuMemAddressReserve,
 * ::cuMemImportFromShareableHandle
 */
...
/**
 * \brief Maps or unmaps subregions of sparse CUDA arrays and sparse CUDA
 mipmapped arrays
 *
 * Performs map or unmap operations on subregions of sparse CUDA arrays and
 sparse CUDA mipmapped arrays.
 * Each operation is specified by a ::CUarrayMapInfo entry in the \p mapInfoList
 array of size \p count.
 ...
 * then ::CUarrayMapInfo::resource::mipmap must be set to a valid sparse CUDA
 ...
 * where
 ...
 indicates a
 * sparse-miplevel which spans at least one tile in every dimension. The
 remaining miplevels which
 * are too small to span at least one tile in any dimension constitute the mip
 tail region as indicated by
 * ::CUarraySparseSubresourceType::CU_ARRAY_SPARSE_SUBRESOURCE_TYPE_MIPTAIL
 subresource type.
 *
 * If ::CUarrayMapInfo::subresourceType is set to
 ::CUarraySparseSubresourceType::CU_ARRAY_SPARSE_SUBRESOURCE_TYPE_SPARSE_LEVEL
 * then ::CUarrayMapInfo::subresource::sparseLevel struct must contain valid
 array subregion offsets and extents.
 * The ::CUarrayMapInfo::subresource::sparseLevel::offsetX,
 ::CUarrayMapInfo::subresource::sparseLevel::offsetY
 * and ::CUarrayMapInfo::subresource::sparseLevel::offsetZ must specify valid X,
 Y and Z offsets respectively.
 * The ::CUarrayMapInfo::subresource::sparseLevel::extentWidth,
 ::CUarrayMapInfo::subresource::sparseLevel::extentHeight
 * and ::CUarrayMapInfo::subresource::sparseLevel::extentDepth must specify
 valid width, height and depth extents respectively.
 * These offsets and extents must be aligned to the corresponding tile
 dimension.
 * For CUDA mipmapped arrays ::CUarrayMapInfo::subresource::sparseLevel::level
 must specify a valid mip level index. Otherwise,
 * must be zero.
 * For layered CUDA arrays and layered CUDA mipmapped arrays
 ...
 * ::CUarrayMapInfo::subresource::sparseLevel::offsetZ must be zero and
 ::CUarrayMapInfo::subresource::sparseLevel::extentDepth
 * must be set to 1 for 2D and 2D layered CUDA arrays and CUDA mipmapped arrays.
 * Tile extents can be obtained by calling ::cuArrayGetSparseProperties and
 ...
 * ::CUarrayMapInfo::subresource::miptail::offset and size in
 ::CUarrayMapInfo::subresource::miptail::size.
 * Both, mip tail offset and mip tail size must be aligned to the tile size.
 * For layered CUDA mipmapped arrays which don't have the flag
 ::CU_ARRAY_SPARSE_PROPERTIES_SINGLE_MIPTAIL set in
 ::CUDA_ARRAY_SPARSE_PROPERTIES::flags
 ...
 * ::CUarrayMapInfo::memOperationType specifies the type of operation.
 ...
 CUmemOperationType; \endcode
 * If ::CUarrayMapInfo::memOperationType is set to
 ::CUmemOperationType::CU_MEM_OPERATION_TYPE_MAP then the subresource
 * will be mapped onto the tile pool memory specified by
 ::CUarrayMapInfo::memHandle at offset ::CUarrayMapInfo::offset.
 * The tile pool allocation has to be created by specifying the
 ...
 *
 * If ::CUarrayMapInfo::memOperationType is set to
 ::CUmemOperationType::CU_MEM_OPERATION_TYPE_UNMAP then an unmapping operation
 * is performed. ::CUarrayMapInfo::memHandle must be NULL.
 *
 * ::CUarrayMapInfo::deviceBitMask specifies the list of devices that must map
 or unmap physical memory.
 * Currently, this mask must have exactly one bit set, and the corresponding
 device must match the device associated with the stream.
 * If ::CUarrayMapInfo::memOperationType is set to
 ::CUmemOperationType::CU_MEM_OPERATION_TYPE_MAP, the device must also match
 * the device associated with the tile pool memory allocation as specified by
 ::CUarrayMapInfo::memHandle.
 *
 * ::CUarrayMapInfo::flags and ::CUarrayMapInfo::reserved[] are unused and must
 be set to zero.
 *
 * \return
 * ::CUDA_SUCCESS,
 ...
 * \param[in] hStream     - Stream identifier for the stream to use for map or
 unmap operations
 *
 * \sa ::cuMipmappedArrayCreate, ::cuArrayCreate, ::cuArray3DCreate,
 ::cuMemCreate, ::cuArrayGetSparseProperties,
 ::cuMipmappedArrayGetSparseProperties
 */
 ...
 * address reservation and can be used for a future calls to ::cuMemMap.  Any
 * new mapping to this virtual address will need to have access granted through
...
/**
 * \brief Set the access flags for each location specified in \p desc for the
 ...
 *
 * \param[out] shareableHandle - Pointer to the location in which to store the
 * requested handle type \param[in] handle           - CUDA handle for the
 * memory allocation \param[in] handleType       - Type of shareable handle
 * requested (defines type and size of the \p shareableHandle output parameter)
 ...
 *
 * \note Importing shareable handles exported from some graphics APIs(VUlkan,
 * OpenGL, etc) created on devices under an SLI group may not be supported, and
 * thus this API will return CUDA_ERROR_NOT_SUPPORTED. There is no guarantee
 * that the contents of \p handle will be the same CUDA memory handle for the
 ...
 * \param[in]  osHandle     - Shareable Handle representing the memory
 * allocation that is to be imported. \param[in]  shHandleType - handle type of
 * the exported handle ::CUmemAllocationHandleType. \returns
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
 * ::CUDA_ERROR_NOT_INITIALIZED,
 * ::CUDA_ERROR_DEINITIALIZED,
...
/**
 * \brief Retrieve the contents of the property structure defining properties
 * for this handle
 *
 * \param[out] prop  - Pointer to a properties structure which will hold the
 * information about this handle \param[in] handle - Handle which to perform the
 * query on \returns
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
 * ::CUDA_ERROR_NOT_INITIALIZED,
...
/**
 * \brief Given an address \p addr, returns the allocation handle of the backing
 * memory allocation.
 *
 * The handle is guaranteed to be the same handle value used to map the memory.
 * If the address requested is not mapped, the function will fail. The returned
 * handle must be released with corresponding number of calls to ::cuMemRelease.
 *
 ...
 *
 * ___MANBRIEF___ Functions for performing allocation and free operations in
 * stream order. Functions for controlling the behavior of the underlying
 * allocator.
 * (___CURRENT_FILE___) ___ENDMANBRIEF___
 *
 ...
 * outside of the promised stream order, a use before allocation / use after
 * free error will cause undefined behavior.
 *
 ...
 * The allocator may refer to internal stream ordering as well as inter-stream
 * dependencies (such as CUDA events and null stream dependencies) when
 * establishing the temporal guarantee. The allocator may also insert
 * inter-stream dependencies to establish the temporal guarantee.
 *
 * \section CUDA_MALLOC_ASYNC_support Supported Platforms
 *
 * Whether or not a device supports the integrated stream ordered memory
 * allocator may be queried by calling ::cuDeviceGetAttribute() with the device
 * attribute
 * ::CU_DEVICE_ATTRIBUTE_MEMORY_POOLS_SUPPORTED
 */
 ...
 * behavior.
 *
 * \note During stream capture, this function results in the creation of a free
 ...
 * ::CUDA_ERROR_INVALID_VALUE,
 * ::CUDA_ERROR_NOT_INITIALIZED,
 * ::CUDA_ERROR_INVALID_CONTEXT (default stream specified with no current
 * context),
 * ::CUDA_ERROR_NOT_SUPPORTED
 */
 ...
 * The allocation must not be accessed until the the allocation operation
 * completes. The allocation comes from the memory pool current to the stream's
 * device.
 *
 * \note The default memory pool of a device contains device memory from that
 * device. \note Basic stream ordering allows future work submitted into the
 * same stream to use the allocation. Stream query, stream synchronize, and CUDA
 * events can be used to guarantee that the allocation operation completes
 * before work submitted in a separate stream runs. \note During stream capture,
 * this function results in the creation of an allocation node.  In this case,
 *       the allocation is owned by the graph instead of the memory pool. The
 * memory pool's properties are used to set the node's creation parameters.
 *
 * \param[out] dptr    - Returned device pointer
 * \param[in] bytesize - Number of bytes to allocate
 * \param[in] hStream  - The stream establishing the stream ordering contract
 * and the memory pool to allocate from \returns
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
 * ::CUDA_ERROR_NOT_INITIALIZED,
 * ::CUDA_ERROR_INVALID_CONTEXT (default stream specified with no current
 ...
 * minBytesToKeep reserved bytes, or there is no more memory that the allocator
 * can safely release. The allocator cannot release OS allocations that back
 * outstanding asynchronous allocations. The OS allocations may happen at
 * different granularity from the user allocations.
 *
 * \note: Allocations that have not been freed count as outstanding.
 * \note: Allocations that have been asynchronously freed but whose completion
 * has not been observed on the host (eg. by a synchronize) can count as
 * outstanding.
 *
 * \param[in] pool           - The memory pool to trim
 * \param[in] minBytesToKeep - If the pool has less than minBytesToKeep
 * reserved, the TrimTo operation is a no-op.  Otherwise the pool will be
 * guaranteed to have at least minBytesToKeep bytes reserved after the
 * operation. \returns
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_NOT_INITIALIZED,
 * ::CUDA_ERROR_INVALID_VALUE
 ...
 * trying to release memory back to the OS. When more than the release threshold
 * bytes of memory are held by the memory pool, the allocator will try to
 * release memory back to the OS on the next call to stream, event or context
 * synchronize. (default 0)
 * - ::CU_MEMPOOL_ATTR_REUSE_FOLLOW_EVENT_DEPENDENCIES: (value type = int)
 *                    Allow ::cuMemAllocAsync to use memory asynchronously freed
 *                    in another stream as long as a stream ordering dependency
 *                    of the allocating stream on the free action exists.
 *                    Cuda events and null stream interactions can create the
 ...
 *                    Allow ::cuMemAllocAsync to insert new stream dependencies
 *                    in order to establish the stream ordering required to
 * reuse a piece of memory released by ::cuMemFreeAsync (default enabled).
 * - ::CU_MEMPOOL_ATTR_RESERVED_MEM_HIGH: (value type = cuuint64_t)
 *                    Reset the high watermark that tracks the amount of backing
 * memory that was allocated for the memory pool. It is illegal to set this
 * attribute to a non-zero value.
 * - ::CU_MEMPOOL_ATTR_USED_MEM_HIGH: (value type = cuuint64_t)
 *                    Reset the high watermark that tracks the amount of used
 ...
 *                    Amount of backing memory currently allocated for the
 * mempool
 * - ::CU_MEMPOOL_ATTR_RESERVED_MEM_HIGH: (value type = cuuint64_t)
 *                    High watermark of backing memory allocated for the mempool
 * since the last time it was reset.
 * - ::CU_MEMPOOL_ATTR_USED_MEM_CURRENT: (value type = cuuint64_t)
 *                    Amount of memory from the pool that is currently in use by
 * the application.
 * - ::CU_MEMPOOL_ATTR_USED_MEM_HIGH: (value type = cuuint64_t)
 *                    High watermark of the amount of memory from the pool that
 ...
 * \param[in] map   - Array of access descriptors. Each descriptor instructs the
 * access to enable for a single gpu. \param[in] count - Number of descriptors
 * in the map array.
 *
 * \returns
 * ::CUDA_SUCCESS,
 ...
 *
 * \param[out] flags   - the accessibility of the pool from the specified
 * location \param[in] memPool  - the pool being queried \param[in] location -
 ...
 *
 * Creates a CUDA memory pool and returns the handle in \p pool.  The \p
 * poolProps determines the properties of the pool such as the backing device
 * and IPC capabilities.
 *
 * By default, the pool's memory will be accessible from the device it is
 * allocated on.
 *
 * \note Specifying CU_MEM_HANDLE_TYPE_NONE creates a memory pool that will not
 * support IPC.
 *
 * \returns
 * ::CUDA_SUCCESS,
 ...
 * when ::cuMemPoolDestroy is invoked, the function will return immediately and
 * the resources associated with the pool will be released automatically once
 ...
 * A pointer to the allocated memory is returned immediately in *dptr.
 * The allocation must not be accessed until the the allocation operation
 * completes. The allocation comes from the specified memory pool.
 *
 * \note
 *    -  The specified memory pool may be from a device different than that of
 * the specified \p hStream.
 *
 *    -  Basic stream ordering allows future work submitted into the same stream
 * to use the allocation. Stream query, stream synchronize, and CUDA events can
 * be used to guarantee that the allocation operation completes before work
 * submitted in a separate stream runs.
 *
 * \note During stream capture, this function results in the creation of an
 ...
 * mempool with ::cuMemPoolImportFromShareableHandle. Individual pointers can
 * then be shared with the ::cuMemPoolExportPointer and ::cuMemPoolImportPointer
 * APIs. The implementation of what the shareable handle is and how it can be
 * transferred is defined by the requested handle type.
 *
 * \note: To create an IPC capable mempool, create a mempool with a
 ...
 * ::CUDA_ERROR_OUT_OF_MEMORY
 *
 * \sa ::cuMemPoolExportToShareableHandle, ::cuMemPoolExportPointer,
 * ::cuMemPoolImportPointer
 */
 ...
 *
 * Constructs \p shareData_out for sharing a specific allocation from an already
 * shared memory pool. The recipient process can import the allocation with the
 * ::cuMemPoolImportPointer api. The data is not a handle and may be shared
 ...
 * ::CUDA_ERROR_OUT_OF_MEMORY
 *
 * \sa ::cuMemPoolExportToShareableHandle, ::cuMemPoolImportFromShareableHandle,
 * ::cuMemPoolImportPointer
 */
 ...
 * pointer may be freed with cuMemFree or cuMemFreeAsync.  If cuMemFreeAsync is
 * used, the free must be completed on the importing process before the free
 ...
 *
 *      If \p ptr is not a valid CUDA pointer then ::CUDA_ERROR_INVALID_VALUE is
 * returned.
 *
 * - ::CU_POINTER_ATTRIBUTE_DEVICE_ORDINAL:
 *
 ...
 *      pointer \p ptr.  Note that this is not necessarily the size of the
 * mapped region, but the size of the mappable address range \p ptr references
 ...
 * - ::CU_POINTER_ATTRIBUTE_MEMPOOL_HANDLE:
 *
 *      Returns in \p *data the handle to the mempool that the allocation was
 * obtained from.
 *
 * \par
 *
 ...
 *
 * Note there is a later version of this API, ::cuStreamGetCaptureInfo_v2. It
 * will supplant this version in 12.0, which is retained for minor version
 * compatibility.
 *
 ...
 *
 * This version of cuStreamGetCaptureInfo is introduced in CUDA 11.3 and will
 * supplant the previous version in 12.0. Developers requiring compatibility
 * across minor versions to CUDA 11.0 (driver version 445) should use
 * ::cuStreamGetCaptureInfo or include a fallback path.
 *
 * \param hStream - The stream to query
 * \param captureStatus_out - Location to return the capture status of the
 * stream; required \param id_out - Optional location to return an id for the
 * capture sequence, which is unique over the lifetime of the process \param
 ...
 * graph while the capture sequence is in progress. This API does not transfer
 *           ownership of the graph, which is transferred or destroyed at
 *           ::cuStreamEndCapture. Note that the graph handle may be invalidated
 * before end of capture for certain errors. Nodes that are or become
 *           unreachable from the original stream at ::cuStreamEndCapture due to
 * direct actions on the graph do not trigger
 * ::CUDA_ERROR_STREAM_CAPTURE_UNJOINED. \param dependencies_out - Optional
 * location to store a pointer to an array of nodes. The next node to be
 * captured in the stream will depend on this set of nodes, absent operations
 * such as event wait which modify this set. The array pointer is valid until
 * the next API call which operates on the stream or until end of capture. The
 * node handles may be copied out and are valid until they or the graph is
 * destroyed. The driver-owned array may also be passed directly to APIs that
 * operate on the graph (not the stream) without copying. \param
 ...
 *
 * Modifies the dependency set of a capturing stream. The dependency set is the
 * set of nodes that the next captured node in the stream will depend on.
 *
 ...
 * the API is added to the existing set or replaces it. A flags value of 0
 * defaults to ::CU_STREAM_ADD_CAPTURE_DEPENDENCIES.
 *
 * Nodes that are removed from the dependency set via this API do not result in
 * ::CUDA_ERROR_STREAM_CAPTURE_UNJOINED if they are unreachable from the stream
 * at
 * ::cuStreamEndCapture.
 *
 ...
 * ::cuEventRecordWithFlags(), an event represents an empty set of work, so for
...
* If the NvSciBuf object imported into CUDA is also mapped by other drivers,
then the
* application must use ::cuWaitExternalSemaphoresAsync or
::cuSignalExternalSemaphoresAsync
* as appropriate barriers to maintain coherence between CUDA and the other
drivers.
* See ::CUDA_EXTERNAL_SEMAPHORE_SIGNAL_SKIP_NVSCIBUF_MEMSYNC and
 ...
 *
 * If \p extMem was imported from a handle of type
 ::CU_EXTERNAL_MEMORY_HANDLE_TYPE_NVSCIBUF, then
 ...
 *
 * If ::CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC::type is
 * ::CU_EXTERNAL_SEMAPHORE_HANDLE_TYPE_TIMELINE_SEMAPHORE_WIN32, then exactly
 one
 * of ::CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC::handle::win32::handle and
 * ::CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC::handle::win32::name must not be
 * NULL. If
 ...
 * ::CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS::params::nvSciSync::fence to a value
 * that can be used by subsequent waiters of the same NvSciSync object to order
 * operations with those currently submitted in \p stream. Such an update will
 * overwrite previous contents of
 ...
 * memory synchronization operations to be performed over all external memory
 * objects that are imported as
 * ::CU_EXTERNAL_MEMORY_HANDLE_TYPE_NVSCIBUF. This ensures that any subsequent
 * accesses made by other importers of the same set of NvSciBuf memory object(s)
 * are coherent. These operations can be skipped by specifying the flag
 * ::CUDA_EXTERNAL_SEMAPHORE_SIGNAL_SKIP_NVSCIBUF_MEMSYNC, which can be used as
 * a performance optimization when data coherency is not required. But
 * specifying this flag in scenarios where data coherency is required results in
 * undefined behavior. Also, for semaphore object of the type
 * ::CU_EXTERNAL_SEMAPHORE_HANDLE_TYPE_NVSCISYNC, if the NvSciSyncAttrList used
 ...
 * will wait until the
 * ::CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS::params::nvSciSync::fence is signaled
 * by the signaler of the NvSciSyncObj that was associated with this semaphore
 * object. By default, waiting on such an external semaphore object causes
 ...
 * this flag in scenarios where data coherency is required results in undefined
 * behavior. Also, for semaphore object of the type
 * ::CU_EXTERNAL_SEMAPHORE_HANDLE_TYPE_NVSCISYNC, if the NvSciSyncAttrList used
 * to create the NvSciSyncObj had not set the flags in
 * ::cuDeviceGetNvSciSyncAttributes to CUDA_NVSCISYNC_ATTR_WAIT, this API will
 * return CUDA_ERROR_NOT_SUPPORTED.
 *
 * If the semaphore object is any one of the following types:
 * ::CU_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D11_KEYED_MUTEX,
 ...
 * If the handle returned by this API refers to a module loaded by the CUDA
 * runtime, calling ::cuModuleUnload() on that module will result in undefined
 * behavior.
 *
 ...
 * The CUDA driver retains asynchronous behavior by growing the per-thread stack
 ...
 *
 * 2) Kernel parameters for non-cooperative kernels can also be packaged by the
 * application into a single buffer that is passed in via \p extra. This places
 * the burden on the application of knowing each kernel parameter's size and
 * alignment/padding within the buffer. The \p extra parameter exists to allow
 * this function to take additional less commonly used arguments. \p extra
 * specifies a list of names of extra settings and their corresponding values.
 * Each extra setting name is immediately followed by the corresponding value.
 ...
 * ::CUDA_ERROR_INVALID_VALUE will be returned if \p extra is used for a
 * cooperative kernel.
 *
 ...
 * entries. A handle to the new node will be returned in \p phGraphNode.
 *
 * If \p hGraph contains allocation or free nodes, this call will return an
 * error.
 *
 ...
 *
 * Creates a new event record node and adds it to \p hGraph with \p
 * numDependencies dependencies specified via \p dependencies and event
 * specified in \p event. It is possible for \p numDependencies to be 0, in
 * which case the node will be placed at the root of the graph. \p dependencies
 * may not have any duplicate entries. A handle to the new node will be returned
 * in \p phGraphNode.
 *
 ...
 *
 * Creates a new event wait node and adds it to \p hGraph with \p
 * numDependencies dependencies specified via \p dependencies and event
 * specified in \p event. It is possible for \p numDependencies to be 0, in
 * which case the node will be placed at the root of the graph. \p dependencies
 * may not have any duplicate entries. A handle to the new node will be returned
 * in \p phGraphNode.
 *
 * The graph node will wait for all work captured in \p event.  See
 * ::cuEventRecord() for details on what is captured by an event. \p event may
 ...
 * objects when the node is launched.  The operation(s) will occur after all of
 * the node's dependencies have completed.
 *
 * \param phGraphNode     - Returns newly created node
 * \param hGraph          - Graph to which to add the node
 * \param dependencies    - Dependencies of the node
 ...
 *
 * Returns the parameters of an external semaphore signal node \p hNode in \p
 * params_out. The \p extSemArray and \p paramsArray returned in \p params_out,
 * are owned by the node.  This memory remains valid until the node is destroyed
 * or its parameters are modified, and should not be modified directly. Use
 * ::cuGraphExternalSemaphoresSignalNodeSetParams to update the parameters of
 * this node.
 *
 * \param hNode      - Node to get the parameters for
 ...
 *
 * Sets the parameters of an external semaphore signal node \p hNode to \p
 * nodeParams.
 *
 * \param hNode      - Node to set the parameters for
 * \param nodeParams - Parameters to copy
 ...
 *
 * Creates a new external semaphore wait node and adds it to \p hGraph with \p
 * numDependencies dependencies specified via \p dependencies and arguments
 * specified in \p nodeParams. It is possible for \p numDependencies to be 0, in
 * which case the node will be placed at the root of the graph. \p dependencies
 * may not have any duplicate entries. A handle to the new node will be returned
 ...
 * when the node is launched.  The node's dependencies will not be launched
 ...
 *
 * Returns the parameters of an external semaphore wait node \p hNode in \p
 * params_out. The \p extSemArray and \p paramsArray returned in \p params_out,
 * are owned by the node.  This memory remains valid until the node is destroyed
 * or its parameters are modified, and should not be modified directly. Use
 * ::cuGraphExternalSemaphoresSignalNodeSetParams to update the parameters of
 ...
 *
 * Sets the parameters of an external semaphore wait node \p hNode to \p
 * nodeParams.
 *
 * \param hNode      - Node to set the parameters for
 * \param nodeParams - Parameters to copy
 ...
 *
 * Creates a new allocation node and adds it to \p hGraph with \p
 * numDependencies dependencies specified via \p dependencies and arguments
 * specified in \p nodeParams. It is possible for \p numDependencies to be 0, in
 * which case the node will be placed at the root of the graph. \p dependencies
 * may not have any duplicate entries. A handle to the new node will be returned
 ...
 * after the allocation node but before the free node. These allocations cannot
 * be freed outside the owning graph, and they can only be freed once in the
 * owning graph.
 *
 * If the allocation is not freed in the same graph, then it can be accessed not
 * only by nodes in the graph which are ordered after the allocation node, but
 * also by stream operations ordered after the graph's execution but before the
 * allocation is freed.
 *
 ...
 * ::cuMemFreeAsync for every unfreed allocation.
 *
 * It is not possible to free an allocation in both the owning graph and another
 * graph.  If the allocation is freed in the same graph, a free node cannot be
 * added to another graph.  If the allocation is freed in another graph, a free
 * node can no longer be added to the owning graph.
 *
 * The following restrictions apply to graphs which contain allocation and/or
 * memory free nodes:
 ...
 * ::cuGraphAddMemsetNode
 */
CUresult CUDAAPI cuGraphAddMemAllocNode(CUgraphNode *phGraphNode,
                                        CUgraph hGraph,
                                        const CUgraphNode *dependencies,
                                        size_t numDependencies,
 ...
 * The \p poolProps and \p accessDescs returned in \p params_out, are owned by
 * the node.  This memory remains valid until the node is destroyed.  The
 ...
 *
 * Creates a new memory free node and adds it to \p hGraph with \p
 * numDependencies dependencies specified via \p dependencies and arguments
 * specified in \p nodeParams. It is possible for \p numDependencies to be 0, in
 * which case the node will be placed at the root of the graph. \p dependencies
 * may not have any duplicate entries. A handle to the new node will be returned
 ...
 *
 * ::cuGraphAddMemFreeNode will return ::CUDA_ERROR_INVALID_VALUE if the user
 * attempts to free:
...
/**
 * \brief Free unused memory that was cached on the specified device for use
 * with graphs back to the OS.
 *
 * Blocks which are not in use by a graph that is either currently executing or
 * scheduled to execute are freed back to the operating system.
 *
 ...
 *
 * Nodes which belong to a graph which contains allocation or free nodes cannot
 * be destroyed. Any attempt to do so will return an error.
 *
 ...
 *
 * Updates the work represented by \p hNode in \p hGraphExec as though \p hNode
 * had contained \p copyParams at instantiation.  hNode must remain in the graph
 * which was used to instantiate \p hGraphExec.  Changed edges to and from hNode
 * are ignored.
 *
 * The source and destination memory in \p copyParams must be allocated from the
 * same contexts as the original source and destination memory.  Both the
 * instantiation-time memory operands and the memory operands in \p copyParams
 ...
 *
 * \param hGraphExec - The executable graph in which to set the specified node
 * \param hNode      - Memcpy node from the graph which was used to instantiate
 * graphExec \param copyParams - The updated parameters to set \param ctx -
 ...
 *
 * Updates the work represented by \p hNode in \p hGraphExec as though \p hNode
 * had contained \p memsetParams at instantiation.  hNode must remain in the
 * graph which was used to instantiate \p hGraphExec.  Changed edges to and from
 * hNode are ignored.
 *
 ...
 * memory operand and the memory operand in \p memsetParams must be
 ...
 *
 * \param hGraphExec   - The executable graph in which to set the specified node
 * \param hNode        - Memset node from the graph which was used to
 * instantiate graphExec \param memsetParams - The updated parameters to set
 * \param ctx          - Context on which to run the node
 *
 * \return
 * ::CUDA_SUCCESS,
 ...
 *
 * Updates the work represented by \p hNode in \p hGraphExec as though \p hNode
 * had contained \p nodeParams at instantiation.  hNode must remain in the graph
 * which was used to instantiate \p hGraphExec.  Changed edges to and from hNode
 * are ignored.
 *
 * The modifications only affect future launches of \p hGraphExec.  Already
 ...
 *
 * \param hGraphExec - The executable graph in which to set the specified node
 * \param hNode      - Host node from the graph which was used to instantiate
 * graphExec \param nodeParams - The updated parameters to set
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
 ...
 * graphExec.
 *
 * Updates the work represented by \p hNode in \p hGraphExec as though the nodes
 * contained in \p hNode's graph had the parameters contained in \p childGraph's
 * nodes at instantiation. \p hNode must remain in the graph which was used to
 * instantiate \p hGraphExec. Changed edges to and from \p hNode are ignored.
 *
 * The modifications only affect future launches of \p hGraphExec.  Already
 * enqueued or running launches of \p hGraphExec are not affected by this call.
 * \p hNode is also not modified by this call.
 *
 * The topology of \p childGraph, as well as the node insertion order,  must
 * match that of the graph contained in \p hNode.  See ::cuGraphExecUpdate() for
 * a list of restrictions on what can be updated in an instantiated graph.  The
 * update is recursive, so child graph nodes contained within the top level
 * child graph will also be updated.
 *
 * \param hGraphExec - The executable graph in which to set the specified node
 * \param hNode      - Host node from the graph which was used to instantiate
 * graphExec \param childGraph - The graph supplying the updated parameters
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
 ...
 *
 * \param hGraphExec - The executable graph in which to set the specified node
 * \param hNode      - event record node from the graph from which graphExec was
 * instantiated \param event      - Updated event to use
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
 ...
 *
 * \param hGraphExec - The executable graph in which to set the specified node
 * \param hNode      - event wait node from the graph from which graphExec was
 * instantiated \param event      - Updated event to use
 *
 * \return
 * ::CUDA_SUCCESS,
...
/**
 * \brief Sets the parameters for an external semaphore signal node in the given
 * graphExec
 *
 * Sets the parameters of an external semaphore signal node in an executable
 * graph \p hGraphExec. The node is identified by the corresponding node \p
 * hNode in the non-executable graph, from which the executable graph was
 * instantiated.
 *
 ...
 *
 * \param hGraphExec - The executable graph in which to set the specified node
 * \param hNode      - semaphore signal node from the graph from which graphExec
 * was instantiated \param nodeParams - Updated Parameters to set
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
...
/**
 * \brief Sets the parameters for an external semaphore wait node in the given
 * graphExec
 *
 * Sets the parameters of an external semaphore wait node in an executable graph
 * \p hGraphExec. The node is identified by the corresponding node \p hNode in
 * the non-executable graph, from which the executable graph was instantiated.
 *
 * \p hNode must not have been removed from the original graph.
 *
 * The modifications only affect future launches of \p hGraphExec. Already
 ...
 *
 * \param hGraphExec - The executable graph in which to set the specified node
 * \param hNode      - semaphore wait node from the graph from which graphExec
 * was instantiated \param nodeParams - Updated Parameters to set
 *
 * \return
 * ::CUDA_SUCCESS,
 ...
 * Uploads of the same \p hGraphExec will be serialized. Each upload is ordered
 * behind both any previous work in \p hStream and any previous launches of \p
 * hGraphExec. Uses memory cached by \p stream to back the allocations owned by
 * \p hGraphExec.
 *
 ...
 * graphs.
 *
 * If any allocations created by \p hGraphExec remain unfreed (from a previous
 * launch) and \p hGraphExec was not instantiated with
 ...
 *
 * Updates the node parameters in the instantiated graph specified by \p
 * hGraphExec with the node parameters in a topologically identical graph
 * specified by \p hGraph.
 *
 * Limitations:
 *
 * - Kernel nodes:
 ...
 * change.
 *   - The source/destination memory must be allocated from the same contexts as
 * the original source/destination memory.
 ...
 *
 * - The count of nodes directly in \p hGraphExec and \p hGraph differ, in which
 * case \p hErrorNode_out is NULL.
 * - A node is deleted in \p hGraph but not not its pair from \p hGraphExec, in
 * which case \p hErrorNode_out is NULL.
 * - A node is deleted in \p hGraphExec but not its pair from \p hGraph, in
 * which case \p hErrorNode_out is the pairless node from \p hGraph.
 * - The dependent nodes of a pair differ, in which case \p hErrorNode_out is
 * the node from \p hGraph.
 *
 * cuGraphExecUpdate sets \p updateResult_out to:
 * - CU_GRAPH_EXEC_UPDATE_ERROR if passed an invalid value.
 * - CU_GRAPH_EXEC_UPDATE_ERROR_TOPOLOGY_CHANGED if the graph topology changed
 * - CU_GRAPH_EXEC_UPDATE_ERROR_NODE_TYPE_CHANGED if the type of a node changed,
 * in which case \p hErrorNode_out is set to the node from \p hGraph.
 * - CU_GRAPH_EXEC_UPDATE_ERROR_UNSUPPORTED_FUNCTION_CHANGE if the function
 * changed in an unsupported way(see note above), in which case \p
 ...
 * hErrorNode_out is set to the node from \p hGraph
 *
 * If \p updateResult_out isn't set in one of the situations described above,
 * the update check passes and cuGraphExecUpdate updates \p hGraphExec to match
 * the contents of \p hGraph.  If an error happens during the update, \p
 * updateResult_out will be set to CU_GRAPH_EXEC_UPDATE_ERROR; otherwise, \p
 * updateResult_out is set to CU_GRAPH_EXEC_UPDATE_SUCCESS.
 *
 ...
 * \param hErrorNode_out The node which caused the permissibility check to
 * forbid the update, if any \param updateResult_out Whether the graph update
 * was permitted.  If was forbidden, the reason why
 *
 * \return
 * ::CUDA_SUCCESS,
 ...
 *
 * Using the provided \p hGraph, write to \p path a DOT formatted description of
 * the graph. By default this includes the graph topology, node types, node id,
 * kernel names and memcpy direction. \p flags can be specified to write more
 * detailed information about each node type such as parameter values, kernel
 * attributes, node and function handles.
 *
 * \param hGraph - The graph to create a DOT file from
 * \param path   - The path to write the DOT file to
 * \param flags  - Flags from CUgraphDebugDot_flags for specifying which
 ...
 *
 * See CUDA User Objects in the CUDA C++ Programming Guide for more information
 * on user objects.
 *
 * \param object_out      - Location to return the user object handle
 * \param ptr             - The pointer to pass to the destroy function
 * \param destroy         - Callback to free the user object when it is no
 * longer in use \param initialRefcount - The initial refcount to create the
 * object with, typically 1. The initial references are owned by the calling
 * thread. \param flags           - Currently it is required to pass
 * ::CU_USER_OBJECT_NO_DESTRUCTOR_SYNC, which is the only defined flag. This
 * indicates that the destroy callback cannot be waited on by any CUDA API.
 * Users requiring synchronization of the callback should signal its completion
 *                          manually.
 *
 * \return
 * ::CUDA_SUCCESS,
 ...
 *
 * Retains new references to a user object. The new references are owned by the
 * caller.
 *
 * See CUDA User Objects in the CUDA C++ Programming Guide for more information
 * on user objects.
 ...
 * \param count  - The number of references to retain, typically 1. Must be
 ...
 *
 * Releases user object references owned by the caller. The object's destructor
 * is invoked if the reference count reaches zero.
 *
 * It is undefined behavior to release references not owned by the caller, or to
 * use a user object handle after all references are released.
 *
 * See CUDA User Objects in the CUDA C++ Programming Guide for more information
 * on user objects.
 *
 * \param object - The object to release
 * \param count  - The number of references to release, typically 1. Must be
 * nonzero and not larger than INT_MAX.
 *
 * \return
 * ::CUDA_SUCCESS,
 ...
 * \param count  - The number of references to add to the graph, typically 1.
 * Must be nonzero and not larger than INT_MAX. \param flags  - The optional
 * flag ::CU_GRAPH_USER_OBJECT_MOVE transfers references from the calling
...
/**
 * \brief Returns dynamic shared memory available per block when launching \p
 * numBlocks blocks on SM
 *
 * Returns in \p *dynamicSmemSize the maximum size of dynamic shared memory to
 * allow \p numBlocks blocks per SM.
 *
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetMipmapLevelBias(float *pbias,
                                                              CUtexref hTexRef);
 ...
 * ::cuTexRefGetFilterMode, ::cuTexRefGetFlags, ::cuTexRefGetFormat
 */
__CUDA_DEPRECATED CUresult CUDAAPI cuTexRefGetMipmapLevelClamp(
 ...
 *
 * ___MANBRIEF___ driver entry point access functions of the low-level CUDA
 * driver API
 * (___CURRENT_FILE___) ___ENDMANBRIEF___
 *
 * This section describes the driver entry point access functions of the
 * low-level CUDA driver application programming interface.
 *
 * @{
 */
 ...
 * CUDA version is greater than or equal to the CUDA version in which the driver
 * symbol was introduced, this API will return the function pointer to the
 * corresponding versioned function.
 *
 * The pointer returned by the API should be cast to a function pointer matching
 * the requested driver function's definition in the API header file. The
 * function pointer typedef can be picked up from the corresponding typedefs
 * header file. For example, cudaTypedefs.h consists of function pointer
 * typedefs for driver APIs defined in cuda.h.
 *
 * The API will return ::CUDA_ERROR_NOT_FOUND if the requested driver function
 * is not supported on the platform, no ABI compatible driver function exists
 * for the specified \p cudaVersion or if the driver symbol is invalid.
 *
 * The requested flags can be:
 * - ::CU_GET_PROC_ADDRESS_DEFAULT: This is the default mode. This is equivalent
 * to
 *   ::CU_GET_PROC_ADDRESS_PER_THREAD_DEFAULT_STREAM if the code is compiled
 * with
 *   --default-stream per-thread compilation flag or the macro
 ...
 * including the per-thread versions. If a per-thread version is not found, the
 * API will return the legacy version of the driver function.
 *
 * \param symbol - The base name of the driver API function to look for. As an
 * example, for the driver API ::cuMemAlloc_v2, \p symbol would be cuMemAlloc
 * and \p cudaVersion would be the ABI compatible CUDA version for the _v2
 * variant. \param pfn - Location to return the function pointer to the
 * requested driver function \param cudaVersion - The CUDA version to look for
 * the requested driver symbol \param flags -  Flags to specify search options.
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE,
...
CUresult CUDAAPI cuCtxCreate(CUcontext *pctx, unsigned int flags, CUdevice dev);
CUresult CUDAAPI cuModuleGetGlobal(CUdeviceptr_v1 *dptr, unsigned int *bytes,
                                   CUmodule hmod, const char *name);
...
CUresult CUDAAPI cuMemAllocPitch(CUdeviceptr_v1 *dptr, unsigned int *pPitch,
                                 unsigned int WidthInBytes, unsigned int Height,
                                 unsigned int ElementSizeBytes);
CUresult CUDAAPI cuMemFree(CUdeviceptr_v1 dptr);
CUresult CUDAAPI cuMemGetAddressRange(CUdeviceptr_v1 *pbase,
                                      unsigned int *psize, CUdeviceptr_v1 dptr);
CUresult CUDAAPI cuMemAllocHost(void **pp, unsigned int bytesize);
CUresult CUDAAPI cuMemHostGetDevicePointer(CUdeviceptr_v1 *pdptr, void *p,
                                           unsigned int Flags);
CUresult CUDAAPI cuMemcpyHtoD(CUdeviceptr_v1 dstDevice, const void *srcHost,
                              unsigned int ByteCount);
CUresult CUDAAPI cuMemcpyDtoH(void *dstHost, CUdeviceptr_v1 srcDevice,
                              unsigned int ByteCount);
CUresult CUDAAPI cuMemcpyDtoD(CUdeviceptr_v1 dstDevice,
                              CUdeviceptr_v1 srcDevice, unsigned int ByteCount);
CUresult CUDAAPI cuMemcpyDtoA(CUarray dstArray, unsigned int dstOffset,
                              CUdeviceptr_v1 srcDevice, unsigned int ByteCount);
CUresult CUDAAPI cuMemcpyAtoD(CUdeviceptr_v1 dstDevice, CUarray srcArray,
...
CUresult CUDAAPI cuMemcpyHtoDAsync(CUdeviceptr_v1 dstDevice,
                                   const void *srcHost, unsigned int ByteCount,
                                   CUstream hStream);
CUresult CUDAAPI cuMemcpyDtoHAsync(void *dstHost, CUdeviceptr_v1 srcDevice,
                                   unsigned int ByteCount, CUstream hStream);
CUresult CUDAAPI cuMemcpyDtoDAsync(CUdeviceptr_v1 dstDevice,
                                   CUdeviceptr_v1 srcDevice,
                                   unsigned int ByteCount, CUstream hStream);
CUresult CUDAAPI cuMemcpy2DAsync(const CUDA_MEMCPY2D_v1 *pCopy,
                                 CUstream hStream);
CUresult CUDAAPI cuMemcpy3DAsync(const CUDA_MEMCPY3D_v1 *pCopy,
                                 CUstream hStream);
CUresult CUDAAPI cuMemsetD8(CUdeviceptr_v1 dstDevice, unsigned char uc,
                            unsigned int N);
CUresult CUDAAPI cuMemsetD16(CUdeviceptr_v1 dstDevice, unsigned short us,
                             unsigned int N);
CUresult CUDAAPI cuMemsetD32(CUdeviceptr_v1 dstDevice, unsigned int ui,
                             unsigned int N);
CUresult CUDAAPI cuMemsetD2D8(CUdeviceptr_v1 dstDevice, unsigned int dstPitch,
                              unsigned char uc, unsigned int Width,
                              unsigned int Height);
CUresult CUDAAPI cuMemsetD2D16(CUdeviceptr_v1 dstDevice, unsigned int dstPitch,
                               unsigned short us, unsigned int Width,
                               unsigned int Height);
CUresult CUDAAPI cuMemsetD2D32(CUdeviceptr_v1 dstDevice, unsigned int dstPitch,
                               unsigned int ui, unsigned int Width,
                               unsigned int Height);
CUresult CUDAAPI cuArrayCreate(CUarray *pHandle,
                               const CUDA_ARRAY_DESCRIPTOR_v1 *pAllocateArray);
CUresult CUDAAPI cuArrayGetDescriptor(
    CUDA_ARRAY_DESCRIPTOR_v1 *pArrayDescriptor, CUarray hArray);
CUresult CUDAAPI cuArray3DCreate(
    CUarray *pHandle, const CUDA_ARRAY3D_DESCRIPTOR_v1 *pAllocateArray);
CUresult CUDAAPI cuArray3DGetDescriptor(
    CUDA_ARRAY3D_DESCRIPTOR_v1 *pArrayDescriptor, CUarray hArray);
CUresult CUDAAPI cuTexRefSetAddress(unsigned int *ByteOffset, CUtexref hTexRef,
                                    CUdeviceptr_v1 dptr, unsigned int bytes);
CUresult CUDAAPI cuTexRefSetAddress2D(CUtexref hTexRef,
                                      const CUDA_ARRAY_DESCRIPTOR_v1 *desc,
                                      CUdeviceptr_v1 dptr, unsigned int Pitch);
