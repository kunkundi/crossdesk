...
| 网络与部署 | P2P 直连、TURN 中继、SRTP 媒体加密、自托管信令与中继服务 |
| Windows 锁屏控制 | 通过 CrossDesk Service 支持锁屏、登录界面及安全桌面的输入转发 |
| Linux 无头运行 | 复用已有桌面和应用，或创建独立 Xvfb 虚拟桌面；支持画面采集与键鼠控制，见 [运行说明](docs/HEADLESS.md) |
...
<p align="center">
  <img src="docs/images/desktop-settings-zh.png" width="720" alt="设置界面示例" />
</p>
